...
<div class="w">
  ...
  <?php if($show == menu): ?><code>&gt;</code> <a href=""><?php echo ($catename['cat_name']); ?></a> <code></code>   </div><?php endif; ?>
  <?php if($show == menu1): ?><code>&gt;</code> <a href="/book/index.php/Home/Index/index?id=<?php echo ($menu1['id']); ?>"><?php echo ($menu1['cat_name']); ?></a> <code></code>  
  <code>&gt;</code> <a href=""><?php echo ($catename['cat_name']); ?></a> <code></code>   </div><?php endif; ?>
</div>
...
<?php if(($_SESSION['id'])): ?><div class="mt">
  ...
  <div class="mc">
    ...
    <div class="right-extra" style="min-height: 800px;"> 
        <div class="box">
              <div id="filter" class="">
               <div style="height:0px; line-height:0px; clear:both;"></div>
                  <div class="contact_left" style="width: 50%;min-height: 400px;background-color: white;float: left;">
                      <div style="height: 550px;width: 100%;margin-left: 20px;line-height: 50px;">
                        <p><span style="margin-left: 50px;">联系人：</span>  <span ><?php echo ($contact['contact_name']); ?></span></p>
                        <p><span style="margin-left: 50px;">联系电话：</span>  <span ><?php echo ($contact['contact_mobile']); ?></span></p>
                        <p><span style="margin-left: 50px;">联系地址：</span>  <span ><?php echo ($contact['contact_address']); ?></span></p>
                        <div class="weichat">
                            <img  style="width: 80%;height: 500px;border:1px solid #ccc;" src="<?php echo IMG_URL . $contact['contact_weichat']; ?>">
                        </div>
                      </div>
                  </div>
                  <div class="contact_right" style="width: 50%;min-height: 400px;background-color: white;float: right;">
                    <h2 style="font-weight: bold;font-size: 16px;">公司简介：</h2>
...
<div class="footer-service" >
    ...
    <div class="bnav3">
        ...
        <ul>
            <li><a href="/book/index.php/Home/Index/regist">注册新会员</a></li>
            <li><a href="/book/index.php/Home/Index/login">会员登录</a></li>            
        </ul>
    </div>
