...
<div class="w">
 ...
 &gt;</code> <a href="">活动</a> <code></code>   </div>
        ...
        <div class="box">
              ...
              <form method="GET" name="listform" action="category.php">
                          <div class="fore1" style="border:none;">
                            <dl class="order">
                              <dt>排序：</dt>
                              <dd class="<?php echo ($curr); ?>"><a href="/book/index.php/Home/Goods/activity?id=<?php echo ($_GET['id']); ?>">时间↑</a></dd>
                              <dd class="<?php echo ($curr1); ?>"><a href="/book/index.php/Home/Goods/activity_down?id=<?php echo ($_GET['id']); ?>">时间↓</a></dd>
                              <dd class="<?php echo ($curr2); ?>"><a href="/book/index.php/Home/Goods/activity_price_up?id=<?php echo ($_GET['id']); ?>">价格↑</a></dd>
                              <dd class="<?php echo ($curr3); ?>"><a href="/book/index.php/Home/Goods/activity_price_down?id=<?php echo ($_GET['id']); ?>">价格↓</a></dd>
                      </dl>
                       ...
                       <ul class="list_pic">
                            <?php if(is_array($fooddata)): foreach($fooddata as $key=>$item): ?><li class="item" style="margin-left:20px;margin-bottom: 40px;" id="li_32115">
                                      <div class="goods-content" style="position:relative">
                                            ...
                                            <div class="goods-price"> <em class="sale-price" title="本店价：<?php echo ($item['shop_price']); ?>">
                                              活动价：  <?php echo ($item['shop_price']); ?>
                                          
                                            </em> <em class="market-price" title=""><?php echo ($item['market_price']); ?></em>
                                                 <em>
