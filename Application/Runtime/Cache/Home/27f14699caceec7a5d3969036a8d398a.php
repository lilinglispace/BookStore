...
<div class="list">
 <ul>
  ...
  <li>
  <p class="list_img"><a href="<?php echo U('Home/Goods/detail',array('id'=>$vo['id'],'isbn'=>$vo['isbn']));?>"><img src="<?php echo IMG_URL . $v['goods_img']; ?>" /></a></p>
  <p class="list_word"><?php echo ($v["goods_name"]); ?></p>
  <p class="price"><strike>￥<?php echo ($v["original_price"]); ?></strike>&nbsp;&nbsp;&nbsp;&nbsp;<span>￥<?php echo ($v["price"]); ?></span></p>
  </li>   
  <?php endforeach ?>
 </ul>
</div>
