...
<ul>
<li class="this_type">
<a href="<?php echo U('Home/Goods/xiaoshuo',array('id'=>0));?>">全部</a>
</li>
<?php if(is_array($sty)): $i = 0; $__LIST__ = $sty;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/goods/xiaoshuo',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<!--  小说列表展示 -->
<div class="list">
 <ul>
