...
<div class="w">
  ...
  <code>&gt;</code> <a href="">新闻</a> <code></code>   </div>
...
<div id="weekRank" class="m rank">
  ...
  <div class="mc">
    ...
    <div class="right-extra"> 
        <div class="box">
            <?php if(( $show == 'newslist')): ?><div id="filter" class="">
               <div style="height:0px; line-height:0px; clear:both;"></div>
                <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                    <div class="squares clearfix">
                       <ul class="list_pic">
                            <?php if(is_array($news)): foreach($news as $key=>$item): ?>{
                                <li class="item" style="margin-left:20px;margin-bottom: 40px;" id="li_32115">
                                      <div class="goods-content" style="position:relative;height: 100px;">
                                             <div class="goods-name"><a href="/book/index.php/Home/Index/news_info?id=<?php echo ($item['id']); ?>" target="_blank" title="<?php echo ($item['goods_name']); ?>"><?php echo ($item['title']); ?><em></em></a></div>
                                             <div class="goods-name"><a href="/book/index.php/Home/Index/news_info?id=<?php echo ($item['id']); ?>" target="_blank" title="<?php echo ($item['goods_name']); ?>"><?php echo ($item['user']); ?><em></em></a></div>
                                             <div class="goods-name"><a href="/book/index.php/Home/Index/news_info?id=<?php echo ($item['id']); ?>" target="_blank" title="<?php echo ($item['goods_name']); ?>"><?php echo date('Y-m-d H:m:s',$item['time'] )?><em></em></a></div>
          ...
          <?php if(( $show == 'newsinfo')): ?><div id="filter" class="" style="background-color: white;">
              <div class="news_title" style="line-height: 50px;"><?php echo ($news['title']); ?></div>
              <div class="news_user">作者：<?php echo ($news['user']); ?><span style="float: right;"><?php echo date("Y-m-d H:i",$news['time']) ?></span></div>
               <div style="height:0px; line-height:0px; clear:both;"></div>
