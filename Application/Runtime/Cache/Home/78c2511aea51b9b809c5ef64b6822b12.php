...
<body>
    ...
    <div class="user-xin"><p>我的信息</p></div>
     <form enctype="multipart/form-data" action="<?php echo U('home/person/editmine');?>" method="post" name="theForm"> 
    <div class="user-tou">
        <ul>
            <li class="toul"><img src="/book/Public/Upload/Admin/User/<?php echo ($user["img"]); ?>"></li>
            <li class="tour">
                <h4 name="mine"><?php echo (cookie('username')); ?></h4>
                <span>上传头像</span> <input type="file" name="img"/>
            ...
            <div class="user-biao">
            <p><span>用户名：</span><input type="text" class="ming-txt" name="username" readonly value="<?php echo ($user["username"]); ?>"></p>
            <p><span>邮箱：</span><input type="email" class="ming-txt" name="email" value="<?php echo ($user["email"]); ?>"></p>
            <p><span>电话：</span> <input type="text" class="ming-txt" name="tel" value="<?php echo ($user["tel"]); ?>"> 
            </div>
            <div class="baoxiu">
                <input type="submit" class="txt-bao" value="保存">
            </div>
        </form>
