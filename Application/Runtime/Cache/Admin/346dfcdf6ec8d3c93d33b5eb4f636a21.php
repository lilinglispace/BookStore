...
<body>
<div class="pd-20">
	<form action="<?php echo U('admin/goods/add');?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="author" required id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">出版商：</label>
			<div class="formControls col-4">
				<input type="text" name="press" required id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">原价：</label>
			<div class="formControls col-4">
				<input type="text" name="price" required id="" placeholder="" value="" class="input-text" style="width:90%">
				元</div>
			<label class="form-label col-2">热销价：</label>
			<div class="formControls col-4">
				<input type="text" name="price_hot" required id="" placeholder="" value="" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">库存：</label>
			<div class="formControls col-4">
				<input type="text" name="reserve" required id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">书籍摘要：</label>
			<div class="formControls col-10">
				<textarea name="desc" cols="" required rows="" class="textarea"></textarea>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2">图书详情：</label>
			<div class="formControls col-10">
				<div class="uploader-thum-container">
					<div id="fileList" class="uploader-list"></div>
					<input type="file" name="img_desc[]" multiple required />
				</div>
			</div>
		</div>
		<div class="row cl">
