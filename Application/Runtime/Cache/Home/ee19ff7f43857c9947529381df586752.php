...
<div class="comment-pin">
  <div class="commentl">
    <img src="/book/Public/Upload/Admin/Goods/<?php echo ($goods["img"]); ?>">
    <h3><?php echo ($goods["name"]); ?></h3>
    <p>价格：￥<?php echo ($goods["price_hot"]); ?></p>
    
  </div>
<form action="<?php echo U('home/buy/comment');?>" method="post" id="commentFrom">
  <div class="commentr">
  <h3>书籍评价<span>请写下你的建议!</span></h3>
  <div class="commentr-con">
    <div class="comment-word">商品评价：</div>
    <div class="comment-text"><textarea name="content" id="content"><?php echo ($comment["content"]); ?></textarea></div>
    <input type="hidden" name="goods_id" value="<?php echo ($goods["id"]); ?>" />
  </div>
  <div style="height:20px;clear:both;"></div>

  <div class="comment-btn"><input type="submit" value="确认提交" class="commentbtn"/></div>
  </div>
  </form>
</div>
