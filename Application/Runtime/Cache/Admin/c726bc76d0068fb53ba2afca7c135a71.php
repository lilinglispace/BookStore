...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="<?php echo U('admin/ad/add');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		<?php if(is_array($show)): foreach($show as $k=>$admin): ?><tr class="text-c">
				<td><?php echo ($k+1+(($_GET[p]?:1)-1)*10); ?></td>
				<td><?php echo ($admin["name"]); ?></td>
				<td><?php echo ($admin["email"]); ?></td>
				<td><?php echo ($admin["pwd"]); ?></td>
				<td><?php echo ($admin["time"]); ?></td>
				<td><a href="<?php echo U('admin/ad/edit',array('id'=>$admin['id']));?>">编辑</a>&nbsp|&nbsp<a href="<?php echo U('admin/user/del',array('id'=>$admin['id']));?>" onclick="return del()">删除</a></td>
