...
<link href="/book/Public/Home/css/page.css" rel="stylesheet" type="text/css" />
<script>
$(function(){
...
<div class="zi_title">
 ...
 <span>&nbsp;>&nbsp;</span>
 <span><?php echo ($bookcate["name"]); ?></span>
</div>

<div class="sha_type">
<ul>
<li class="this_type">
<a href="<?php echo U('home/goods/book',array('id'=>$bookcate['id']));?>">全部</a>
</li>
<?php if(is_array($sonbook)): $i = 0; $__LIST__ = $sonbook;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/goods/book',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<!--  小说列表展示 -->
<div class="list">
 <ul>
	 <?php if(is_array($book)): foreach($book as $key=>$goods): ?><li>
		 	<p class="list_img"><a href="<?php echo U('Home/Goods/detail',array('id'=>$goods['id'],'isbn'=>$goods['isbn']));?>"><img src="/book/Public/Upload/Admin/Goods/<?php echo ($goods["img"]); ?>"></a></p>
		 	<p class="list_word"><?php echo ($goods["name"]); ?></p>
		 	<p class="price"><strike>￥<?php echo ($goods["price"]); ?></strike>&nbsp;&nbsp;&nbsp;&nbsp;<span>￥<?php echo ($goods["price_hot"]); ?></span></p>
